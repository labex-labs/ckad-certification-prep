# Обучение CKAD Certification Prep Path
...
#### Проектирование и сборка рабочих нагрузок
...
#### Конфигурация, хранилище и параметры среды выполнения
...
#### Наблюдаемость, отладка и сетевое взаимодействие приложений
...
#### Проектирование и сборка приложения
...
#### Наблюдаемость и обслуживание приложения
...
#### Среда, конфигурация и безопасность приложения
